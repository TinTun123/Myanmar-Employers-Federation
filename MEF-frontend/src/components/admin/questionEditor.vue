<template>
  <div class="flex flex-col gap-4 md:w-[80%] border-b-2 border-light-green pb-4">
    ...
    <div class="flex justify-between items-center">
      ...
      <button
        class="flex gap-2 px-2 py-1 rounded-full border border-[#F3462B] text-xs text-[#F3462B]"
      >
        <span class="text-[#F3462B] text-xs">Delete</span>
        <svg
          width="12"
          height="12"
          viewBox="0 0 12 12"
    ...
    <div>
      <div class="">
        <label for="type" class="text-xs md:text-sm font-semibold">Select Question Type:</label>
      </div>
      <div class="mt-2 w-[30%] md:w-[45%] relative">
        ...
        <div class="w-4 h-4 absolute top-1/2 right-3 -translate-y-1/2 pointer-events-none">
          <svg
            class="text-gray-500 sm:size-4 w-full h-full"
            viewBox="0 0 16 16"
            fill="currentColor"
            aria-hidden="true"
            data-slot="icon"
    ...
    <div class="flex flex-col gap-2 md:gap-4 md:w-[60%]">
      <label :for="'question_text_' + model.data" class="text-xs md:text-sm font-semibold"
        >Question Text:</label
      >
    ...
    <div class="flex flex-col gap-2 md:gap-4 md:w-[80%]">
      <div>
        <label :for="'question_text_' + model.id" class="text-xs md:text-sm font-semibold"
          >Description:</label
        >
      </div>
