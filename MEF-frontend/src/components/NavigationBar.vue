<template>
    ...
    <div v-if="deviceType === 'mobile' || deviceType === 'tablet'"
        ...
        <div class="h-8 w-8 flex items-center justify-center rounded-sm">
            <img src="../assets/mef logo.jpeg" class="w-full h-full rounded-sm" alt="">
        </div>
    ...
    <div v-else :class="[deviceType === 'desktop' && isDashboard ? 'relative' : 'absolute']"
        ...
        <div class="h-12 w-12 flex items-center justify-center rounded-sm">
            <img src="../assets/mef logo.jpeg" class="w-full h-full rounded-sm" alt="">
        </div>
    ...
    <transition name="dropdown" appear>
        <div @click="isMenuOpen = !isMenuOpen" v-if="isMenuOpen"
            class="flex flex-col justify-center items-stratch absolute top-[48px] left-0 right-0 z-100"
