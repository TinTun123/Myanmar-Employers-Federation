<template>
  ...
  <div class="my-4 md:my-8 px-4 py-2 bg-white shadow-lg rounded-full inline-block mx-6">
  ...
  <div class="mr-4">
    <button
      @click="goTo('adminEditStatements')"
  ...
  <div class="flex flex-col mx-6 my-6 gap-4 md:my-6 md:mx-6 md:grid md:grid-cols-12">
    <StatementCard
      class="md:col-span-5 lg:col-span-4"
      :class="[index % 2 === 0 || index === 0 ? 'md:col-start-2' : '']"
